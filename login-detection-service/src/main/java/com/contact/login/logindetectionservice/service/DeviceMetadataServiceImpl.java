...
public class DeviceMetadataServiceImpl implements DeviceMetadataService {
  ...
  @Autowired private DatabaseReader databaseReader;

  @Autowired private Parser parser;

  @Autowired DeviceMetadataRepository metadataRepository;
  ...
  @Override
  public boolean allowLoginOrRegisterDevice(
      IsLoginAllowed isLoginAllowed, HttpServletRequest request)
